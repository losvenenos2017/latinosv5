...
<!--    -->
          ...
          <div class="contenido">
            ...
            <div class="descip_caballeros"><strong> Caballeros </strong> 
            </div> 
                  
            <div class="descrip_jovenes"><strong> Jovenes </strong> 
            </div> 

            <div class="descrip_niños"><strong> Niños </strong> 
            </div> 

            <div class="descip_otros"><strong> Otros </strong> 
            </div> 
