...
<!--    -->
          <?php include_once('php/header.inc'); ?>
            ...
            <div class="contenido">
                ...
                <div class="datoscontacto"> <center> 
                            <label>Telefono:
                                <strong>(1) 456 21 90</strong> <br>
                            </label>
                            
                            <label>Email:
                                <strong><a href="mailto:LatinosBarberShop@hotmail.com">LatinosBarberShop@hotmail.com</a></strong><br>
                            </label>
                                    
                            <label>Direccion:
                                <strong> Carrera 78f N° 70-39 / Barrio las Ferias<br>
                                        Bogota D.c, Colombia</strong>
                            </label><br><br> 
                                            </center>
                </div>
